...
function limpar(A,B,X){
	if (peca.id == casaA.className&&peca.outerHTML.includes('red')){pecas_comidas.append(document.querySelector('#'+aux[Number(aux.indexOf(peca.id[0]))-1]+String(Number(peca.id[1])-1)))}
	if (peca.id == casaB.className&&peca.outerHTML.includes('red')){pecas_comidas.append(document.querySelector('#'+aux[Number(aux.indexOf(peca.id[0]))+1]+String(Number(peca.id[1])-1)))}
	if (peca.id == casaA.className&&peca.outerHTML.includes('black')){pecas_comidas.append(document.querySelector('#'+aux[Number(aux.indexOf(peca.id[0]))-1]+String(Number(peca.id[1])+1)))}
	if (peca.id == casaB.className&&peca.outerHTML.includes('black')){pecas_comidas.append(document.querySelector('#'+aux[Number(aux.indexOf(peca.id[0]))+1]+String(Number(peca.id[1])+1)))}
